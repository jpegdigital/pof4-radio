...
export function toElements(m: Manifest): Element[] {
  ...
  return [
    { kind: "break", clip: "break-small", bed: m.bed, label: "Full break" },
    { kind: "song", track: s1 },
    ...
    { kind: "break", clip: "break-big", bed: m.bed, label: "Top of the hour" },
    { kind: "song", track: s5, talk: { clip: "talkup-5", over: "intro" } },
  ];
}
